...
def get_files_to_copy_and_zip(lab):
    ...
    src_lab_path = STUDENT_REPO_PATH / "ltag"
    src_libs_path = STUDENT_REPO_PATH / "components"
    dest_lab_path = TEST_REPO_PATH / "ltag"
    ...
    if lab == "m3t1":
        files.append((src_lab_path / "main/coef.h", dest_lab_path / "main", True))
        files.append((src_lab_path / "main/coef.c", dest_lab_path / "main", True))
        files.append((src_lab_path / "main/delay.c", dest_lab_path / "main", True))
        files.append((src_lab_path / "main/filter.c", dest_lab_path / "main", True))
    elif lab == "m3t2":
        ...
        files.append((src_lab_path / "main/lockoutTimer.c", dest_lab_path / "main", True))
    elif lab == "m3t3":
        files.append((src_lab_path / "main/buffer.c", dest_lab_path / "main", True))
        files.append((src_lab_path / "main/rx.c", dest_lab_path / "main", True))
...
def build(lab):
    ...
    build_path = TEST_REPO_PATH / "ltag" / "build"
